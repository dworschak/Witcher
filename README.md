...
- Run [create_symbolic_links.bat](MOD/Witcher/create_symbolic_links.bat) to create symbolic links from CK2 mod folder to the actual folders in your Git working directory
