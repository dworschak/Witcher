...
NDiplomacy = {
	...
	DEMAND_RELIGIOUS_CONVERSION_INTERACTION_PIETY = 750,
...
NMilitary = {
	...
	DAYS_BETWEEN_COMBAT_EVENTS = 7,					-- Combat events will happen every this many days
...
NAI =
{
	...
	MARRIAGE_AI_PRESTIGE_VALUE = 0.25,						-- Multiplier for how highly AI values prestige when arranging marriages and evaluating marriage offers
