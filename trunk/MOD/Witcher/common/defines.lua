...
NDiplomacy = {
	...
	DEMESNE_BONUS_MAX_TECH_EMPEROR = 2,
	DEMESNE_BONUS_MAX_TECH_KING = 2,
	DEMESNE_BONUS_MAX_TECH_DUKE = 1,
...
NMilitary = {
	...
	MERCENARY_HIRE_COST_FACTOR = 0.11,				-- Hire cost factor for mercenary units
